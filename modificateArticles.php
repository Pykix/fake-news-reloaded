...
<div class="container d-md-flex justify-content-around row mx-auto">

    <?php foreach (displayUniqueArticle($db_cnx, $_SESSION['id']) as $elt) : ?>
        <div class="mt-2 border rounded p-2 col-lg-6">
            ...
            <p>Image : <br><img class='w-100' src="<?php echo $elt['image'] ?>" alt="image de l'article"></p>
        </div>
    <?php endforeach; ?>


    <form class="mt-2 col-lg-6" method="post" action="modificateArticles.php" enctype="multipart/form-data">
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-success my-2">Modifier</button>
    </form>
